...
export const LAYER_CATALOG = [
...

  {
    ...
    source: {
      ...
      details: 'Current G-AIRMET polygons filtered for turbulence and low-level wind shear hazards.',
...

  {
    ...
    source: {
      name: 'Aviation Weather Center',
      details: 'Current G-AIRMET polygons filtered for icing-related hazards.',
      url: 'https://aviationweather.gov/data/api',
    },
  },

  {
    ...
    group: 'aviation',
    title: 'SIGMETs',
    subtitle: 'Significant weather advisories',
    visibility: 'both',
    timestampMode: 'latest_snapshot',
    defaultOpacity: 0.82,
    zIndex: 122,
    ...
    source: {
      name: 'Aviation Weather Center',
      details: 'Active CONUS SIGMET polygons for significant in-flight weather hazards.',
      url: 'https://aviationweather.gov/data/api',
    },
  },

  {
    ...
    group: 'aviation',
    title: 'CWAs',
    subtitle: 'Center Weather Advisories',
    visibility: 'nerdy',
    timestampMode: 'latest_snapshot',
    defaultOpacity: 0.78,
    zIndex: 121,
    ...
    source: {
      name: 'Aviation Weather Center',
      details: 'Current Center Weather Advisories highlighting short-fuse operational hazards.',
      url: 'https://aviationweather.gov/data/api',
    },
  },
