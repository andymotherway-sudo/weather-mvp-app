        ...
        <>
          ...
          >
            <MapLibreGL.FillLayer
              id="global-marine-areas-hit-fill"
              minZoomLevel={2}
              maxZoomLevel={7.6}
              style={{
                fillColor: 'rgba(148,163,184,1)',
                fillOpacity: 0,
              }}
            />
            <MapLibreGL.LineLayer
              ...
              style={{
                ...
                lineWidth: [
                  ...
                  ['get', 'precision'],
                  'official',
                  ['interpolate', ['linear'], ['zoom'], 2, 0.75, 7.6, 1.45],
                  'curated',
                  ['interpolate', ['linear'], ['zoom'], 2, 0.6, 7.6, 1.12],
                  ['interpolate', ['linear'], ['zoom'], 2, 0.48, 5, 0.72, 7.6, 0.95],
                ] as any,
          ...
          {selectedGlobalMarineArea ? (
            <MapLibreGL.ShapeSource id="selected-global-marine-area-source" shape={selectedGlobalMarineAreaFc as any}>
              <MapLibreGL.FillLayer
                id="selected-global-marine-area-hit-fill"
                style={{
                  fillColor: 'rgba(148,163,184,1)',
                  fillOpacity: 0,
                }}
              ...
              <MapLibreGL.LineLayer
                ...
                style={{
                  lineColor: 'rgba(186,230,253,0.9)',
                  lineJoin: 'round',
                  lineWidth: ['interpolate', ['linear'], ['zoom'], 2, 1.05, 7, 1.85] as any,
          ...
          >
            ...
            <MapLibreGL.LineLayer
              ...
              minZoomLevel={3.8}
              style={{
                lineColor: 'rgba(56,189,248,0.78)',
                lineJoin: 'round',
                lineWidth: ['interpolate', ['linear'], ['zoom'], 3.8, 0.75, 7.2, 1.12, 10, 1.65] as any,
          ...
          {selectedMarineZone ? (
            <MapLibreGL.ShapeSource id="selected-marine-zone-source" shape={selectedMarineZoneFc as any}>
              <MapLibreGL.FillLayer
                id="selected-marine-zone-hit-fill"
                style={{
                  fillColor: 'rgba(148,163,184,1)',
                  fillOpacity: 0,
                }}
              ...
              <MapLibreGL.LineLayer
                ...
                style={{
                  ...
                  lineJoin: 'round',
                  lineWidth: ['interpolate', ['linear'], ['zoom'], 2, 1.2, 7, 1.9, 10, 2.5] as any,
                  lineOpacity: 0.88 * marineConditionsOpacity,
                }}
              />
            </MapLibreGL.ShapeSource>
          ) : null}
