...
Release: **OMNIwx 1.1.255**
Android version code: **10272**
Track: **Closed testing / internal testing candidate**
Date: **September 14, 2026**

## Play Console Paste Notes

Improves Storm Scope Owned L3 status reporting so testers can verify whether owned NOAA Level III frames and tile templates are active.
...
- Confirm the Storm Scope health line reports `provider=level3`, `requested=level3`, `frames>0`, and `template=level3`.
